...
PurePursuit::PurePursuit() : Node("pure_pursuit_node") {;
    ...
    this->declare_parameter("waypoints_path", "/sim_ws/src/pure_pursuit/racelines/traj_race_cl-2025-02-07 06_48_41.623737.csv");
    ...
    this->declare_parameter("K_i", 0.1);
    this->declare_parameter("I_dist", 3);
    ...
    I_dist = this->get_parameter("I_dist").as_double();
...
void PurePursuit::odom_callback(const nav_msgs::msg::Odometry::ConstSharedPtr odom_submsgObj) {
    ...
    RCLCPP_INFO(this->get_logger(), "odom x:  %.4f  %.4f", x_car_world, y_car_world );
